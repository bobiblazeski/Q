(function(factory) {
     ...
     */
    Q.subtract = _curry2(function subtract(minuend, subtrahend) {
     ...
     */
    Q.difference = _curry2(function difference(subtrahend, minuend) {
        return minuend - subtrahend;
    });
     ...
     *
     */
    Q.divide = _curry2(function divide(dividend, divisor) {
     ...
     *
     */
    Q.quotient = _curry2(function quotient(divisor, dividend) {
        return dividend / divisor;
    });
     ...
     *
     */
    Q.modulo = _curry2(function modulo(dividend, divisor) {
        return dividend % divisor;
    });
     ...
     *      isOdd(21); //=> 1
     */
    Q.remainder = _curry2(function modulo(divisor, dividend) {
        return dividend % divisor;
    });
    /**
